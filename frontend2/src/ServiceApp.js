...
const ServiceApp = () => {
  ...
  return (
     ...
     <Routes>
         ...
         <Route path="/aging/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/discrimination"  element= {<Discrimination URL={URL}/>}/>
         <Route path="/discrimination/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/childcare"  element= {<Childcare URL={URL}/>}/>
         <Route path="/childcare/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/volunteer"  element= {<Volunteer URL={URL}/>}/>
         <Route path="/volunteer/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/support"  element= {<Support URL={URL}/>}/>
         <Route path="/support/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/disabilities"  element= {<Disabilities URL={URL}/>}/>
         <Route path="/disabilities/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/domesticviolence"  element= {<DomesticV URL={URL}/>}/>
         <Route path="/domesticviolence/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/education"  element= {<Education URL={URL}/>}/>
         <Route path="/education/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/employment"  element= {<Employment URL={URL}/>}/>
         <Route path="/employment/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/health"  element= {<Health URL={URL}/>}/>
         <Route path="/health/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/homeless"  element= {<Homeless URL={URL}/>}/>
         <Route path="/homeless/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/housing"  element= {<Housing URL={URL}/>}/>
         <Route path="/housing/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/immigration"  element= {<Immigration URL={URL}/>}/>
         <Route path="/immigration/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/legal"  element= {<Legal URL={URL}/>}/>
         <Route path="/legal/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/lgbtq"  element= {<LGBTQ URL={URL}/>}/>
         <Route path="/lgbtq/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/victim"  element= {<Victim URL={URL}/>}/>
         <Route path="/victim/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/youth"  element= {<Youth URL={URL}/>}/>
         <Route path="/youth/:id"  element= {<Show URL={URL}/>}/>
         <Route path="/veteran"  element= {<Veteran URL={URL}/>}/>
         <Route path="/veteran/:id"  element= {<Show URL={URL}/>}/>
